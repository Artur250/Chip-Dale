...
import "../../Tours/Tours.css" // Подключаем стили для сетки карточек и модального окна
import "./Chuy.css"
...
function Chuy() {
  ...
  // Фильтруем туры, относящиеся к Чуйской области или охватывающие весь Кыргызстан
  const chuyTours = toursData.filter(
    (tour) =>
      tour.regions.includes("chuy") ||
